...
CREATE TABLE Docente (id_docente  INT PRIMARY KEY AUTO_INCREMENT,
...
VALUES ('Tião da Laranja', 'Suco de Laranja', 'CONT-2024-001', 'Vender Suco de Laranja', '5 dias', '12.315.678/0001-99');
